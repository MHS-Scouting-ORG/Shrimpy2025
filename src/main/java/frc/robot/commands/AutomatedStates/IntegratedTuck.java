...
public class IntegratedTuck extends SequentialCommandGroup {
  ElevatorSubsystem elevatorSub;
  AlgaePivot algaePivotSub;

  public IntegratedTuck(ElevatorSubsystem newElevatorSub, AlgaePivot newAlgaePivotSub) {
    elevatorSub = newElevatorSub;
    algaePivotSub = newAlgaePivotSub;
    addCommands(new ProcessorState(elevatorSub), new Tuck(algaePivotSub), new TuckState(elevatorSub));
