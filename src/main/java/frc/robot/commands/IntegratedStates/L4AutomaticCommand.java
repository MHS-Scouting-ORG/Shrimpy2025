...
public class L4AutomaticCommand extends SequentialCommandGroup {

  public L4AutomaticCommand(ElevatorSubsystem elevatorSubsystem, CoralPivotSubsystem coralPivotSubsystem, AlgaePivot algaePivot, CoralIntakeSubsystem coralIntakeSubsystem) {
